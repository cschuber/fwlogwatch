...
Source: fwlogwatch-0.0.25.tar.gz

%description
fwlogwatch produces ipchains and iptables/netfilter log summary reports in
text and HTML form, with the data found it can produce customizable
incident reports from a template and send them to abuse contacts at
offending sites or CERT coordination centers. Finally, it can also run as
daemon and report anomalies or start countermeasures.

%prep

%setup -n fwlogwatch-0.0.25
